...
? Project name: nexus
✔ Created project nexus-0aa9e, manage it at https://dashboard.convex.dev/t/stephyswe/nexus-0aa9e
```

- convex - clerk guide @ https://docs.convex.dev/auth/clerk

* https://dashboard.clerk.com/sign-up - login - create: "nexus" - disable "email, google" - enable "github" - copy two envs keys to .env.local
